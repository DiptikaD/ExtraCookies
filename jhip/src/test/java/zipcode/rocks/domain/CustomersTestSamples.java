...
public class CustomersTestSamples {
    ...
    public static Customers getCustomersSample1() {
        return new Customers().id(1L).email("email1").userName("userName1").password("password1").profilePicIUrl("profilePicIUrl1");
    }

    public static Customers getCustomersSample2() {
        return new Customers().id(2L).email("email2").userName("userName2").password("password2").profilePicIUrl("profilePicIUrl2");
    }
