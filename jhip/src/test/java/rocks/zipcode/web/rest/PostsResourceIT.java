...
import static rocks.zipcode.domain.PostsAsserts.*;
...
import rocks.zipcode.domain.enumeration.Tags;
import rocks.zipcode.repository.PostsRepository;
...
class PostsResourceIT {
    ...
    private static final Tags UPDATED_TAG = Tags.READYMADE;
    ...
    void partialUpdatePostsWithPatch() throws Exception {
        ...
        partialUpdatedPosts.postId(UPDATED_POST_ID).price(UPDATED_PRICE).location(UPDATED_LOCATION);
