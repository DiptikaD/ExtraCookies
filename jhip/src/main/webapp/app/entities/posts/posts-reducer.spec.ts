...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './posts.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_POSTS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_POSTS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_POSTS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_POSTS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_POSTS actions', async () => {
      const arg = 42666;
